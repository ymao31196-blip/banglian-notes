...
| TimesFM、Chronos、Moirai、MOMENT | 通用时间序列基础模型 | 可选 | 可做技术储备和对照，但不是风电专用 |
...
- 论文：<https://arxiv.org/abs/2509.06778>
...
WindFM 当前开源接口是否能直接输入多源未来 NWP 特征，需要实际阅读代码和实验确认。如果它主要使用历史序列和未来时间戳，那么它更适合做对照模型，而不一定是多源气象融合主模型。
...
TimesFM、Chronos、Moirai、MOMENT 等模型可以写成技术储备，但不要作为第一主线。
...
> 作为 WindFM 之外的通用时间序列基础模型对照，用于评估“领域专用基础模型”和“通用时序基础模型”在风电功率预测上的差异。
...
10. 未来是否允许在企业服务器上直接训练 WindFM、TFT、PatchTST 等深度模型？
...
- WindFM 论文：<https://arxiv.org/abs/2509.06778>
