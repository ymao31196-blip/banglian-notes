...
> 开源模型更新（2026-06-12）：新增 Tyan-WP。当前已确认 WindFM 和 Tyan-WP 均属于公开代码与预训练权重的风电功率专用基础模型。
> 调研日期：2026-06-03  
...
截至 2026 年 6 月 12 日，不能再表述为“开源领域只有 WindFM”。目前已确认至少有两个公开代码和预训练权重的风电功率专用基础模型：WindFM 和 Tyan-WP。更准确的判断是：
